    ...
    <div className="min-h-screen bg-[#eee9df]">
      <div className="flex min-h-screen w-full flex-col lg:flex-row">
        ...
        <div className="relative hidden min-h-screen w-1/2 overflow-hidden lg:block">
          <img src={heroImage} alt="Aurelia fashion editorial" className="absolute inset-0 h-full w-full object-cover" />
          ...
          <div className="absolute left-9 top-8 z-10">
            <h2 className="font-serif text-[25px] tracking-[0.14em] text-white">AURELIA</h2>
          </div>

          <div className="absolute bottom-9 left-9 z-10 max-w-[390px] text-white">
            <div className="mb-4 flex items-center gap-4">
              <span className="h-px w-12 bg-white/80" />
              <span className="text-[10px] font-medium tracking-[0.28em] uppercase">New Season · 2026</span>
            </div>
            ...
            <div className="mt-7 flex items-center gap-4">
              <span className="h-px w-12 bg-white/80" />
              <span className="text-[10px] font-medium tracking-[0.25em] uppercase">Discover your style</span>
            </div>
          </div>
        </div>
        ...
        <div className="relative flex h-[190px] w-full overflow-hidden lg:hidden">
          <img src={heroImage} alt="Aurelia fashion" className="absolute inset-0 h-full w-full object-cover" />
          <div className="absolute inset-0 bg-[#c87547]/70 mix-blend-multiply" />
          <div className="absolute left-6 top-6 z-10">
            <h2 className="font-serif text-[21px] tracking-[0.14em] text-white">AURELIA</h2>
          </div>
          <div className="absolute bottom-5 left-6 z-10">
            <p className="text-[8px] font-medium tracking-[0.25em] text-white uppercase">New Season · 2026</p>
            <h1 className="mt-2 font-serif text-[30px] leading-[0.95] text-white">Elegance in<br />every detail.</h1>
          </div>
        </div>
          ...
          <div className="w-full max-w-[410px]">
            ...
            <div>
              <div className="mb-5 flex items-center gap-3">
                ...
                <span className="text-[9px] font-medium tracking-[0.28em] text-[#8c8174] uppercase">Join Aurelia</span>
              </div>
              ...
              <p className="mt-5 max-w-[380px] text-[11px] leading-6 tracking-[0.01em] text-[#81786f]">
                Enter your details to join a world of timeless fashion, curated collections, and effortless style.
              </p>
            </div>
            ...
            <form onSubmit={handleSignup} className="mt-8 flex flex-col gap-5">
              <div>
                <label htmlFor="name" className="mb-2 block text-[9px] font-semibold tracking-[0.18em] text-[#432817] uppercase">
                  Full Name *
                </label>
                <div className="relative">
                  <User size={15} strokeWidth={1.4} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#8a8178]" />
                  <input
              ...
              <div>
                <label htmlFor="email" className="mb-2 block text-[9px] font-semibold tracking-[0.18em] text-[#432817] uppercase">
                  Email Address *
                </label>
                <div className="relative">
                  <Mail size={15} strokeWidth={1.4} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#8a8178]" />
                  <input
              ...
              <div>
                <label htmlFor="password" className="mb-2 block text-[9px] font-semibold tracking-[0.18em] text-[#432817] uppercase">
                  Password *
                </label>
                <div className="relative">
                  <Lock size={15} strokeWidth={1.4} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#8a8178]" />
                  <input
              ...
              {successMessage && (
                <div className="border border-emerald-200 bg-emerald-50/60 px-4 py-3">
                  <p className="text-[10px] leading-5 tracking-wide text-emerald-700">{successMessage}</p>
                </div>
              )}
            ...
            <div className="mt-7 flex items-center gap-4">
              ...
              <span className="text-[8px] font-medium tracking-[0.22em] text-[#958c82] uppercase">Secure access</span>
              <span className="h-px flex-1 bg-[#d5cec3]" />
            </div>

            <div className="mt-6 border border-[#d7d0c5] px-4 py-3.5">
              <p className="text-center text-[9px] leading-5 tracking-wide text-[#8a8178]">
                Your information is securely protected.<br />We never share your personal details.
              </p>
            </div>

            <div className="mt-8 text-center">
              <p className="text-[10px] text-[#8b8177]">Already have an account?</p>
              <Link
                to="/login"
            ...
            <div className="mt-12 text-center">
              <p className="text-[8px] font-medium tracking-[0.18em] text-[#958c82] uppercase">© 2026 Aurelia · All rights reserved</p>
            </div>
